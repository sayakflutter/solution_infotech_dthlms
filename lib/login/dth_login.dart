    ...
    return Material(
      child: Scaffold(
          body: _isVisible && Platform.isWindows
                                                                    ...
                                                                    children: [
                                                                      SizedBox(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () {
                                                                              if (desktop_key.currentState!.validate() & GetUtils.isEmail(signupemail.text)) {
                                                                                desktop_key.currentState!.save();
                                                                                Get.to(
                                                                                    () => OTPScreen(
                                                                                          signupuser.text,
                                                                                          signupname.text,
                                                                                ...
                                                                                Get.snackbar("Error", "Please enter valid details", colorText: Colors.white);
                                                                              }
                                                                            },
                                                                            child:
                                                                                Text(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              if (desktop_key.currentState!.validate()) {
                                                                                desktop_key.currentState!.save();
                                                                                await loginApi(context, loginemail.text, loginpassword.text, loginotp.text);
                                                                                // Get.to(() =>
                                                                                //     const Dashboard());
                                                                                // Navigator.push(
                                                                                //     context,
              ...
              : Platform.isAndroid?Mobilelogin(): Container(
                  color: Colors.black,
                )),
    );
  }
